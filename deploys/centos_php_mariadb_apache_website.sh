...
sudo git clone https://github.com/user/website.git /var/www/html/

print_color "green" "Updating index.php.."
sudo sed -i 's/172.20.1.101/localhost/g' /var/www/html/index.php

print_color "green" "---------------- Setup Website - !!! FINISHED !!! ------------------"
...
do
  check_item "$web_page" $item # double quotes for setting only web_page as arg, because without quotes its html contents will be used as args too
done
